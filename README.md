...
- **How to use it**: Open the "🦙 Alpaca Trade Execution" section, confirm the detected mode, enter a symbol, side, and share quantity, then submit a market order. If the dashboard detects a live account, it requires an explicit confirmation checkbox before submission.
